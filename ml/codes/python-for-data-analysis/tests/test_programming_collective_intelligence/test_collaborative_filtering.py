...
from src.programming_collective_intelligence.collaborative_filtering import sim_distance, sim_pearson, \
...
if __name__ == '__main__':
  ...
  t_movie_critics = transfer_data(movie_critics)
  pprint.pprint(top_match(t_movie_critics,
                'Lady in the Water', sim_func=sim_distance))
  print()
