...
from src.programming_collective_intelligence.decision_tree import get_data, show_data, divide_set, get_target_counts, gini_impurity, entropy, build_tree, display_tree
import pprint
...
class TestDecisionTree(unittest.TestCase):
  ...
  def test_get_keys(self):
    keys = set(['location', 'pages_viewed', 'referrer',
               'service_chosen', 'read_faq'])
    print(keys)
