...
from .tools.data_structure import BaseDataSample, CompareOperation
...
def plot_data(samples):
  ...
  """
  matched_first = [
      sample.first.age for sample in samples if sample.target == 1]
  matched_second = [
      sample.second.age for sample in samples if sample.target == 1]
  unmatched_first = [
      sample.first.age for sample in samples if sample.target == 0]
  unmatched_second = [
      sample.second.age for sample in samples if sample.target == 0]
